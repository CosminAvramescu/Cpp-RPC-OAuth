...
oauth_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case request_access_token:
		_xdr_argument = (xdrproc_t)xdr_userPair;
		_xdr_result = (xdrproc_t)xdr_tokensPair;
		local = (char *(*)(char *, struct svc_req *))request_access_token_1_svc;
		break;

	case validate_delegated_action:
		_xdr_argument = (xdrproc_t)xdr_handleResource;
		_xdr_result = (xdrproc_t)xdr_wrapstring;
	...
	case check_valability:
		_xdr_argument = (xdrproc_t)xdr_wrapstring;
		_xdr_result = (xdrproc_t)xdr_int;
		local = (char *(*)(char *, struct svc_req *))check_valability_1_svc;
		break;
...
int main(int argc, char **argv)
{
	...
	for (int i = 0; i < size; i++)
	{
		...
		u.tokens.requestToken = (char *)malloc(50);
		users.push_back(u);
	}
